...
for (int i = 0; i < names.Length; i++)
{
  ...
  WriteLine($"{names[i]} is at positon {i}.");
}
...
// Jagged array
// C# 11 and earlier must use curly braces and new[] expression
...
static string CheckSwitch(int[] values) => values switch
{
  ...
  [..] => "Any items in any order.", // Trailing comma for easier re-ordering
};
